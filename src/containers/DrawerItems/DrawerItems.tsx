...
import StaffMemberUpdateForm from '../StaffMemberForm/StaffMemberupdateForm';
import OrderUpdateForm from '../Order Form/Order_update_form';

import Sidebar from '../Layout/Sidebar/Sidebar';
import CategoryUpdateForm from '../CategoryForm/category_update-form';
import SubCategoryUpdateForm from '../CategoryForm/sub_category_update';
...
const DRAWER_COMPONENTS = {
  ...
  SUBCATEGORY_UPDATE_FORM: SubCategoryUpdateForm,
  ORDER_UPDATE_FORM: OrderUpdateForm,
  STAFF_MEMBER_FORM: StaffMemberForm,
  UPDATE_STAFF_MEMBER_FORM: StaffMemberUpdateForm,
  SIDEBAR: Sidebar,
};
